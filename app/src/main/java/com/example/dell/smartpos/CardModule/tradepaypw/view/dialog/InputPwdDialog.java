...
import com.example.dell.smartpos.CardModule.tradepaypw.GetPinEmv;
import com.example.dell.smartpos.CardModule.tradepaypw.ImplEmv;
                ...
                try {
                    ...
                    if (listener != null) {
                        if (pindata == null || pindata.length == 0)
                            ...
                            listener.onSucc(TradeApplication.getConvert().bcdToStr(pindata));
                        }
                    }
