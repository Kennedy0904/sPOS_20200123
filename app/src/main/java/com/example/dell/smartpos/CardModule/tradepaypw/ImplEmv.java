...
import com.example.dell.smartpos.CardModule.tradepaypw.abl.core.ActionResult;
import com.example.dell.smartpos.CardModule.tradepaypw.pay.trans.action.ActionEnterPin;
...
import static com.example.dell.smartpos.CardModule.tradepaypw.utils.Utils.bytes2String;
...
//    Added on Phase 2
    private static Activity emvActivity;
    public ImplEmv(Activity activity){
...
//                ((ActionEnterPin) action).setParam(emvContext, pan, onlinePin, totalAmount, leftTimes);
                ((ActionEnterPin) action).setParam(emvActivity, pan, onlinePin, totalAmount, leftTimes);
