...
////                }
//                piccInternal.close();
//                SwingCardActivityActivity.prnTime("polling piccInternal.open start timse = ");
//                piccInternal.open();
//                SwingCardActivityActivity.prnTime("polling piccInternal.open timse = ");
//            }
...
//                piccExternal.open();
//            }
//            //SwingCardActivityActivity.prnTime("Device Open diff = ");
...
//                    //SwingCardActivityActivity.prnTime("icc.detect start ");
//                    boolean ret = icc.detect(SLOT_ICC);
//                    //SwingCardActivityActivity.prnTime("icc.detect diff = ");
//                    if (ret) {
//                        PollingResult result = new PollingResult();
//                        result.setOperationType(PollingResult.EOperationType.OK);
...
//
//                    //SwingCardActivityActivity.prnTime("piccInternal.detect start ");
//                    SwingCardActivityActivity.prnTime("piccInternal.detect start timse = ");
//                    PiccCardInfo info = piccInternal.detect(EDetectMode.EMV_AB);
//                    SwingCardActivityActivity.prnTime("piccInternal.detect diff = ");
//                    if (info != null) {
//                        PollingResult result = new PollingResult();
//                        result.setOperationType(PollingResult.EOperationType.OK);
